...
#         tmp_path = tmp.name
#         # запускаем pg_dump и пишем в файл
#         proc = subprocess.run(
...
# 
#     # открываем файл для чтения и загружаем в Drive
...
#         ).execute()
# 
#     print(f"Dump uploaded as {file_name}, Drive file ID: {file_id}")
#     return file_id
