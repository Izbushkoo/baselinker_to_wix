...
from app.api.v1.routers import auth, users, baselinker_info, allegro_tokens, allegro_sync, werehouse, products, operations
...
api_router.include_router(werehouse.router, prefix="/werehouse", tags=["Werehouse"])
