...
web_router.include_router(catalog.router, prefix="/catalog", tags=["New Catalog Pages"])
web_router.include_router(products.catalog_router, tags=["Old Catalog Pages"])
